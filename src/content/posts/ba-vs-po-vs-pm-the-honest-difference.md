---
author: Arun Mehta
pubDatetime: 2026-05-28T14:01:59.000+05:30
title: "BA vs PO vs PM: the difference nobody writes about honestly"
slug: ba-vs-po-vs-pm-the-honest-difference
featured: true
draft: false
tags:
  - business-analysis
...
- The **Business Analyst** understands the problem space. They talk to stakeholders, model processes, document requirements, and make sure the team is solving the right problem. They are analysis-heavy and often domain experts.
- The **Product Owner** is a Scrum role. They own the backlog, write and prioritise stories, accept or reject completed work, and represent the customer to the development team day to day.
- The **Product Manager** owns the product's direction. Market research, roadmap, pricing, positioning, success metrics, and the business case. They decide what to build and why; the team decides how.
...
- If you decide what gets built and you're accountable for whether it works, you're doing PM-level work regardless of your title.
- If you decide how to slice and sequence what's already been decided, and you're accountable for smooth delivery, you're doing PO-level work regardless of your title.
- If you figure out what the real problem is and whether the proposed solution addresses it, but someone else owns the decision and the outcome, you're doing BA-level work regardless of your title.
...
- The roles overlap massively and the overlap is the norm, not the exception.
- The boundaries are set by org politics and budget, not by the nature of the work.
- The same work happens under all three titles depending on the company.
- The thing that actually distinguishes them is who owns the outcome, and that often doesn't match the title.
